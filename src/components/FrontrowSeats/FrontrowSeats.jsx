            ...
            <div 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink= "http://www.w3.org/1999/xlink" style={{width: "100%", height: "100%"}}>
                    <defs style={{width: "100%", height: "100%"}}>
                        ...
                        <clipPath id="mask" style={{width: "100%", height: "100%"}}>
                            <circle id="mask-circle" cx="55%" cy="50%" r="15%" style={{fill: "#ffffff"}}/>
                            <circle id="mask-circle" cx="25%" cy="95%" r="8%" style={{fill: "#ffffff"}}/>
                    ...
                    <g clipPath="url(#mask)">
                        ...
                        <image className="imagepls" xmlnsXlink= "http://www.w3.org/1999/xlink" xlinkHref="https://raw.githubusercontent.com/AshenCat/speer/master/src/assets/images/IDIDNTKNOWYOUCANDOWNLOADASSETSOMFG/Image4.png" width="100%" />
                    </g>
                ...
                <div className="yellow-text-container">
                    ...
                    <div className="hero-subtext">
                        <h2 className="hero-h">Experience concerts up close and personal. <small>(Object-fit and position isn't working)</small></h2>
                    </div>
